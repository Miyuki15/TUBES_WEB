...
<body class="bg-blue">
    ...
    <aside id="logo-sidebar" class="border-r-4 border-black fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 font-inter bg-blue-500" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto pt-10">
            <a href="" class="flex items-center ps-2.5 mb-5 justify-center">
                <img src="assets/PDF/logo.png" class="h-10 me-3 sm:h-20" alt="Flowbite Logo" />
            </a>
            <ul class="space-y-2 font-medium">
               <li>
                  <a href="/" class="{{ (request()->is('profil')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2  rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="flex-shrink-0 w-5 h-5  transition duration-75 dark:text-gray-400 {{ (request()->is('/')) ? '' : 'group-hover:text-gray-900'}} dark:group-hover:text-grey">
               ...
               <li>
                  ...
                  <a href="/aktivitas" class="{{ (request()->is('aktivitas*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="ms-3">AKTIVITAS</span>
                  </a>
               </li>
               <li>
                  <a href="/seminar" class="{{ (request()->is('seminar*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <li>
                  <a href="/pendamping" class="{{ (request()->is('pendamping*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="ms-3">PENDAMPING</span>
                  </a>
               </li>
               <li>
                  <a href="/tugas-akhir" class="{{ (request()->is('tugas-akhir*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="ms-3">TUGAS AKHIR</span>
                  </a>
               </li>
               <li>
                  <a href="/penguji" class="{{ (request()->is('penguji*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="ms-3">PENGUJI</span>
                  </a>
               </li>
               <li>
                  <a href="/pembimbing" class="{{ (request()->is('pembimbing*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <li>
                  <a href="/pengembangan-pk" class="{{ (request()->is('pengembangan-pk*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="ms-3">PENGEMBANGAN PK</span>
                  </a>
               </li>
               <li>
                  <a href="/pengembangan-ba" class="{{ (request()->is('pengembangan-ba*')) ? 'text-black' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="ms-3">PENGEMBANGAN BAHAN AJAR</span>
                  </a>
               </li>
                  </a>
               </li>
               <li>
                  <a href="/jabatan" class="{{ (request()->is('jabatan*')) ? 'text-black' : 'text-blue-900'}}  flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" viewBox="0 0 14 14">
      ...
      <nav class="bg-blue-500 border-gray-200 w-full flex justify-end items-center h-20"> 
        <div class="flex pr-10 items-center">
            <p class="pr-2">school</p>
            <div class="aspect-square h-10 w-10">
                <img src="assets/PDF/foto.jpg" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="rounded-full aspect-square object-cover float-right cursor-pointer" alt="">
            </div>
        </div>
        <div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
            <div class="py-1">
            <a href="/logout" class="block px-4 py-2 text-sm text-white bg-red-500 hover:bg-red-600 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Log out</a>
            </div>
        </div>
       </nav>
